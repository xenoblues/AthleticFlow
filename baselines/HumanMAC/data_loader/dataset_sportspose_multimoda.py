...
class DatasetSP_multi(Dataset):
    ...
    def process_data(self):
        ...
        if self.multimodal_path is None:
            current_path = os.path.dirname(os.path.abspath(__file__))
            root_path = os.path.dirname(current_path)
            multimodal_path = r"/work7/y_zhou/HumanMAC/data/sportspose/multimodal/t_his45_1_thre0.500_t_pred180_thre0.010_index_filterd.npz"
            candi_path = r"/work7/y_zhou/HumanMAC/data/sportspose/multimodal/data_candi_t_his45_t_pred180_skiprate45.npz"
