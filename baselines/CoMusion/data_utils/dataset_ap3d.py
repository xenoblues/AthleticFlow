...
from .datareader_ap3d import DataReaderAP3D
...
def generate_ap3d_loss_weights(t_length, scale=10):
    """
...
if __name__ == '__main__':
    ...
    # 测试训练模式加载速度
    start = time.time()
    ap3d_train = DatasetAP3D('train', t_his=15, t_pred=60, use_vel=False)
