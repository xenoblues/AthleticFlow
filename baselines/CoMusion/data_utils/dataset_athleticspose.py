...
class DatasetAthleticsPose(Dataset):
    def __init__(self,
                 ...
                 actions='all',
                 use_vel=False,
                 data_path=r"/work7/y_zhou/HumanMAC/data/AthleticsPose",
                 **kwargs):
        self.use_vel = use_vel
        self.data_path = data_path  # 预处理npz文件所在目录
...
if __name__ == '__main__':
    ...
    # 测试训练集加载
    start = time.time()
    train_dataset = DatasetAthleticsPose('train', t_his=15, t_pred=60, use_vel=False)
    ...
    # 测试批量生成器
    generator = train_dataset.sampling_generator(num_samples=1024, batch_size=32)
