...
from .dataset_ap3d import DataReaderAP3D
...
class DatasetAP3D_multi(Dataset):
    ...
    def process_data(self):
        ...
        if self.multimodal_path is None or self.data_candi_path is None:
            current_path = os.path.dirname(os.path.abspath(__file__))
            root_path = os.path.dirname(current_path)
            multimodal_path = (r'/work7/y_zhou/HumanMAC/data/athlete_pose_3d_v3/'
                               r'multimodal/t_his15_top50_t_pred60_thre0.100_filtered_dlow.npz')
            candi_path = (r'/work7/y_zhou/HumanMAC/data/athlete_pose_3d_v3/'
                          r'multimodal/data_candi_t_his15_t_pred60_skiprate15.npz')
