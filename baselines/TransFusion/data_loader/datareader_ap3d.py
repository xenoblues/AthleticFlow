...
class DataReaderAP3D(object):
    def __init__(self, n_frames=125, sample_stride=1, data_stride_train=25, data_stride_test=25, read_confidence=False,
                 dt_root='data/athlete_pose_3d_v3',  normalize_to_neg1_pos1=True,
                 max_joint_range=2.0,
                 max_val=2.1):
        ...
        self.dt_root = r"/work7/y_zhou/HumanMAC/data/athlete_pose_3d_v3"
        ...
        self.dt_dataset = {
            ...
            'valid': self._load_complete_sequences('valid')
        }
        # st2 = time.time()
    ...
    def _compute_and_save_max_val(self):
        max_val_path = os.path.join(self.dt_root, 'ap3d_max_val.npy')
        ...
        self.max_val = raw_max * self.safety_margin
    ...
    def get_test_sequences(self):
        """返回测试集所有完整序列列表"""
        return list(self.dt_dataset['valid'].values())
